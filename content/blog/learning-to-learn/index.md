...
1. The Quick, Intuition, and Non-Conscious brain
2. The Slow, Thinking, and Conscious brain
...
1. Instruction: Before learning any topic, I try to research the best course to learn with, how I should structure my learning, and also let AI guide me through the study plan
2. Training: As I mostly take all my notes on my laptop in a Zettelkasten system, I already have a system that can store all my knowledge. However the system is mostly stale since I take notes and leave them as is. Now I try to quiz myself with AI on all the notes I took weekly, as well as learning more new things here. So both creating new links and strengthening the old ones. Also trying to keep it at 85% Baseline
3. Testing: to put it into practice, I try to write a blog on new topics I encounter weekly, so I put myself through a test and see if what I studied has been grokked or not
